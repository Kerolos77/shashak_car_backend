...
@section('title', trans('global.edit') . ' ' . trans('cruds.faq.title_singular'))
@section('pageName', trans('global.edit') . ' ' . trans('cruds.faq.title_singular'))
    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                <form action="{{ route('admin.faqs.update', $faq->id) }}" method="POST" class="form">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch form-check-custom">
                                <input class="form-check-input" type="checkbox" name="enable" 
                                       id="enable" value="1" {{ old('enable', $faq->enable) ? 'checked' : '' }}>

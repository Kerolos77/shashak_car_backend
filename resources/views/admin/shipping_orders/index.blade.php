...
@section('breadcrumbs')
    <li class="breadcrumb-item text-muted">{{ __('admin.shipping_orders') }}</li>
    <span class="bullet bg-gray-300 w-5px h-2px"></span>
    <li class="breadcrumb-item text-dark">{{ trans('global.list') }}</li>
@endsection

@section('content')
@section('title', __('admin.shipping_orders'))

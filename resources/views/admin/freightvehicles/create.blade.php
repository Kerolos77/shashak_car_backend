    ...
    <div id="kt_app_content_container" class="app-container container-xxxl">
        ...
        <div class="card">
            ...
            <div class="card-body pt-0">
                ...
                <form action="{{ route('admin.freight-vehicles.store') }}" method="POST" enctype="multipart/form-data" class="form">
                    @csrf
                    @method('POST')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="text" name="name" class="form-control form-control-solid"
                                   placeholder="{{ __('cruds.freightVehicle.fields.name') }}" value="{{ old('name') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="number" step="0.5" name="km_charge" class="form-control form-control-solid"
                                   placeholder="{{ __('cruds.freightVehicle.fields.km_charge') }}" value="{{ old('km_charge') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="number" step="0.01" name="height" class="form-control form-control-solid"
                                   placeholder="{{ __('cruds.freightVehicle.fields.height') }}" value="{{ old('height') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <input type="number" step="0.01" name="width" class="form-control form-control-solid"
                                   placeholder="{{ __('cruds.freightVehicle.fields.width') }}" value="{{ old('width') }}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <textarea name="description" class="form-control form-control-solid" rows="3"
                                      placeholder="{{ __('cruds.freightVehicle.fields.description') }}">{{ old('description') }}</textarea>
                        </div>
                    </div>

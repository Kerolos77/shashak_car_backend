            ...
            <form action="{{ route('admin.packages.update', $row->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="image-input image-input-outline {{ $row->photo ? '' : 'image-input-empty' }}" data-kt-image-input="true" style="background-image: url({{ asset('assets/media/svg/files/blank-image.svg') }})">
                                <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ $row->photo }});"></div>

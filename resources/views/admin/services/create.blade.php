                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-lg-8">
                                    <select name="tier_pricing_type" class="form-select form-select-solid">
                                        <option value="flat" {{ (old('tier_pricing_type', 'flat') == 'flat') ? 'selected' : '' }}>
                                            سعر الشريحة المطبقة على الرحلة بالكامل (Flat Rate Tier)
                                        </option>
                                        <option value="cumulative" {{ (old('tier_pricing_type') == 'cumulative') ? 'selected' : '' }}>
...
document.addEventListener('DOMContentLoaded', function () {
    let tierIndex = {{ count(old('price_tiers', [])) }};

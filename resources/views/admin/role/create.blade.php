...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item text-dark">إضافة دور جديد</li>
@endsection
            ...
            <div class="card mb-6 shadow-sm border-0">
                <div class="card-body p-6 d-flex align-items-center justify-content-between flex-wrap gap-4">
                    <div class="d-flex align-items-center gap-4">
                        ...
                        <div>
                            <h2 class="fw-bolder mb-1">إضافة دور وظيفي جديد (Create New Role)</h2>
                            <div class="text-muted fs-6">حدد مسمى الدور الصلاحيات المتاحة للمشرفين التابعين له.</div>
                        </div>
                    </div>
                            ...
                            <div class="card-body pt-2 pb-5">
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach($group['permissions'] as $perm)
                                        @php
                                            $isSelected = in_array($perm['id'], old('permissions', []));
            ...
            <div class="card shadow-sm border-0 mb-8">
                <div class="card-body p-5 d-flex align-items-center justify-content-end gap-3">
                    ...
                    <button class="btn btn-primary fw-bolder px-8" type="submit">
                        <i class="ki-outline ki-check-circle fs-3 me-1"></i> حفظ وتطبييق الدور
                    </button>
                </div>
            </div>

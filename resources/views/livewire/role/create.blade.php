<form wire:submit.prevent="submit" class="pt-5">
    ...
    <div class="mb-5">
        ...
        <input type="text" class="form-control @error('role.title') is-invalid @enderror" wire:model.defer="role.title" required>
        @error('role.title')
    ...
    <div class="mb-5">
        ...
        <small class="text-muted">Total permissions available: {{ count($this->listsForFields['permissions']) }}</small>
    </div>

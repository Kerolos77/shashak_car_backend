 ...
 <div class="symbol symbol-50px symbol-circle me-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        {{ auth()->user()->name }}
                                        <span class="px-2 py-1 badge badge-light-success fw-bold fs-8 ms-2">{{ __('messages.teacher') }}</span>
                                    </div>
                                    <a href="#"
    ...
    <div class="py-4 menu-sub menu-sub-dropdown w-175px">
        <!-- English -->
        <div class="px-3 menu-item">
            <a href="{{ route('lang.switch', 'en') }}" class="px-5 menu-link d-flex {{ app()->getLocale() == 'en' ? 'active' : '' }}">
        ...
        <!-- Arabic -->
        <div class="px-3 menu-item">
            <a href="{{ route('lang.switch', 'ar') }}" class="px-5 menu-link d-flex {{ app()->getLocale() == 'ar' ? 'active' : '' }}">
                <span class="symbol symbol-20px me-4">
    ...
    <!--end::Menu sub-->
                        ...
                        <div class="px-5 menu-item">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="px-5 menu-link"

...
return [
    ...
    'add'                            => 'Add',
    'add_value'                      => 'Add Value',
    'choose_value_type'              => 'Choose the type of value you want to add',
    ...
    'notification_page'                    => [
        ...
        'notification_desc' => 'Target your audience and broadcast Firebase Push Notifications instantly.',
        'target_audience' => 'Target Audience',
        'all_users' => 'All Customers (Users)',
        'all_drivers' => 'All Drivers',
        'specific_user' => 'Specific User or Driver',
        'user_identifier' => 'User/Driver Identifier',
        'search_user' => 'Search by Name, Phone, Email, or ID...',
        'no_search_results' => 'No matching results found...',
        'notification_title' => 'Notification Title',
        'notification_title_placeholder' => 'Example: 50% Off your next ride!',
        'notification_body' => 'Notification content',
        'notification_body_placeholder' => 'Detailed notification content...',
        'attached_image' => 'Attached Image (Optional)',
        'attached_image_desc' => 'Upload a promotional image for the notification (Max 2MB).',
        'uploading_image' => 'Uploading image...',
        'send_notification_now' => 'Send Notification Now',
        'sending_to_app' => 'Sending to App...',
        'success' => 'Success',
        'error' => 'Error',
        'target_not_found' => 'No users found with an active FCM Token in the selected category.',
        'sent_successfully' => 'Successfully sent to :count users.',
    ],
    'all'                                  => 'All',
    'amount'                               => 'Amount',
    'answer'                               => 'Answer',
